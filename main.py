"""Создает персонажа для игры."""
from random import randint


def attack(char_name: str, char_class: str) -> str:
    """Рассчет атаки в режиме тренировки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчет заблокированного урона в режиме тренировки."""
    if char_class == 'warrior':
...
def main():
    """Запусает игру, выводит текст приветствия."""
